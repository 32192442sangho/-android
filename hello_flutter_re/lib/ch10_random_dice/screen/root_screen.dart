...
import 'package:hello_flutter_re/ch10_random_dice/screen/home_screen.dart';
import 'package:hello_flutter_re/ch10_random_dice/screen/settings_screen.dart';
import 'dart:math';
...
class RootScreen extends StatefulWidget {
  ...
  @override
  State<RootScreen> createState() => _RootScreenState(); // rootscreen => 상태 위젯의 최상위
}
...
class _RootScreenState extends State<RootScreen> with TickerProviderStateMixin{    // ➊
  ...
  void initState() {
    ...
    controller = TabController(length: 2, vsync: this);  // ➋ v => vertical(수직)
